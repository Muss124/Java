...
public class FractionSet {
    ...
    public int getCachedGreater(RationalFraction target) {
        if (cachedGreater.get(target) == null) {
            ...
            return cachedGreater.get(target);
        }
    }
    ...
    public int getCachedLesser(RationalFraction target) {
        if (cachedLesser.get(target) == null) {
            ...
            return cachedLesser.get(target);
        }
    }
    ...
    public RationalFraction maximal() {
        ...
        for (RationalFraction fraction : fractions) {
            ...
            if (RationalFraction.isGreater(fraction, res)) {
                res = fraction;
            }
        }
        cachedMaximal = res;
    ...
    public RationalFraction minimal() {
        ...
        for (RationalFraction fraction : fractions) {
            ...
            if (RationalFraction.isGreater(res, fraction)) {
                res = fraction;
            }
        }
    ...
    public int greater(RationalFraction target) {
        int res = 0;
        for (RationalFraction fraction : fractions) {
            if (RationalFraction.isGreater(target, fraction)) {
                res++;
            }
        }
    ...
    public int lesser(RationalFraction target) {
        int res = 0;
        for (RationalFraction fraction : fractions) {
            if (RationalFraction.isGreater(fraction, target)) {
                res++;
            }
        }
